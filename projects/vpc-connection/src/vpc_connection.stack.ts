...
export class VpcConnectionStack extends Stack {
  public constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    new NodejsFunction(this, 'QuicksightVpcConnectionFn', {
      entry: 'src/vpc_connection.handler.ts',
      ...
      functionName: 'quicksight-vpc-connection',
